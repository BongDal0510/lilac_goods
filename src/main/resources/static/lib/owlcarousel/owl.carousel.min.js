...
!function(t, e, i, s) {
    ...
    n = {
        ...
        a.Pipe = [{
            ...
            run: function() {
                var t = this._clones;
                (this.$stage.children(".cloned").length !== t.length || !this.settings.loop && t.length > 0) && (this.$stage.children(".cloned").remove(),
                    this._clones = [])
            }
        }, {
            filter: ["items", "settings"],
            ...
            run: function() {
                ...
                !this.settings.autoWidth && t.grep(this._mergers, function(t) {
                    ...
                    for (e = 0,
                             i = this._coordinates.length; e < i; e++)
        ...
        a.prototype.onDragStart = function(s) {
            var n, o, r, a;
            if (3 === (n = s.originalEvent || s || e.event).which || this.state.isTouch)
                return !1;
        ...
        a.prototype.onDragMove = function(t) {
            var i, n, o, r, a, l;
            this.state.isTouch && !this.state.isScrolling && (n = h(i = t.originalEvent || t || e.event).x,
                o = h(i).y,
                this.drag.currentX = n - this.drag.startX,
                this.drag.currentY = o - this.drag.startY,
                this.drag.distance = this.drag.currentX - this.drag.offsetX,
                this.drag.distance < 0 ? this.state.direction = this.settings.rtl ? "right" : "left" : this.drag.distance > 0 && (this.state.direction = this.settings.rtl ? "left" : "right"),
                this.settings.loop ? this.op(this.drag.currentX, ">", this.coordinates(this.minimum())) && "right" === this.state.direction ? this.drag.currentX -= (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length) : this.op(this.drag.currentX, "<", this.coordinates(this.maximum())) && "left" === this.state.direction && (this.drag.currentX += (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length)) : (r = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum()),
            ...
            (this.drag.distance > 8 || this.drag.distance < -8) && (s !== i.preventDefault ? i.preventDefault() : i.returnValue = !1,
                this.state.isSwiping = !0),
                this.drag.updatedX = this.drag.currentX,
            (this.drag.currentY > 16 || this.drag.currentY < -16) && !1 === this.state.isSwiping && (this.state.isScrolling = !0,
                this.drag.updatedX = this.drag.start),
        ...
        a.prototype.closest = function(e) {
            ...
            return this.settings.freeDrag || t.each(n, t.proxy(function(t, o) {
                return e > o - 30 && e < o + 30 ? i = t : this.op(e, "<", o) && this.op(e, ">", n[t + 1] || o - s) && (i = "left" === this.state.direction ? t + 1 : t),
                -1 === i
            }, this)),
        ...
        a.prototype.normalize = function(e, i) {
            ...
            if (t.isNumeric(e) && !(s < 1))
                return e = this._clones.length ? (e % s + s) % s : Math.max(this.minimum(i), Math.min(this.maximum(i), e))
        }
        ,
        ...
        a.prototype.to = function(i, s) {
            if (this.settings.loop) {
                ...
                a < this.settings.items && !1 === h ? (o = r + this._items.length,
                    this.reset(o)) : a >= l - this.settings.items && !0 === h && (o = r - this._items.length,
                    this.reset(o)),
        ...
        a.prototype.watchVisibility = function() {
            ...
            i(this.$element.get(0)) || (this.$element.addClass("owl-hidden"),
                ...
                this.e._checkVisibile = e.setInterval(t.proxy(function t() {
        ...
        a.prototype.browserSupport = function() {
            ...
            this.support3d && (this.transformVendor = l(["transform", "WebkitTransform", "MozTransform", "OTransform", "msTransform"])[0],
        ...
        n.Defaults = {
            ...
            n.prototype.fetch = function(t, e) {
                var i = t.attr("data-vimeo-id") ? "vimeo" : "youtube"
                    ...
                    , r = t.attr("href");
                if (r) {
                    if ((s = r.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu") > -1)
                        i = "youtube";
            ...
            n.prototype.isInFullScreen = function() {
                ...
                return s && t(s).parent().hasClass("owl-video-frame") && (this._core.speed(0),
                    this._fullscreen = !0),
                (!s || !this._fullscreen || !this._playing) && (this._fullscreen ? (this._fullscreen = !1,
    ...
    function(t, e, i, s) {
        ...
        n.Defaults = {
            ...
            n.prototype.autoplay = function() {
                this.core.settings.autoplay && !this.core.state.videoPlay ? (e.clearTimeout(this.interval),
                    this.interval = e.setTimeout(t.proxy(function() {
                        this.play()
            ...
            n.prototype.destroy = function() {
                var t, i;
                for (t in e.clearInterval(this.interval),
                    this.handlers)
                    this.core.$element.off(t, this.handlers[t]);
    ...
    function(t, e, i, s) {
        ...
        n.Defaults = {
            ...
            n.prototype.draw = function() {
                ...
                if (!n.nav || n.loop || n.navRewind || (this._controls.$previous.toggleClass("disabled", o <= 0),
                    ...
                    n.dotData && 0 !== e) {
                        ...
                        e > 0 ? (s = Array(e + 1).join(this._templates[0]),
                            this._controls.$indicators.append(s)) : e < 0 && this._controls.$indicators.children().slice(e).remove();
